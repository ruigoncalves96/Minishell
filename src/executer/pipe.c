...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/03/28 15:21:46 by hguerrei          #+#    #+#             */
/*   Updated: 2025/03/28 15:21:47 by hguerrei         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../includes/minishell.h"

static void	execute_pipe(t_token *token, t_prompt_info *prompt_info,
		int pipes[2], int std_fileno)
{
