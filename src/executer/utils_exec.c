...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/03/28 15:22:09 by hguerrei          #+#    #+#             */
/*   Updated: 2025/03/28 15:22:11 by hguerrei         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	while (token->previous && token->previous->previous
		&& token->previous->previous->red)
