...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   get_redirection_files.c                            :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: hguerrei < hguerrei@student.42lisboa.co    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/03/28 15:07:07 by hguerrei          #+#    #+#             */
/*   Updated: 2025/03/28 15:07:09 by hguerrei         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool	get_redirection_files(t_token *token)
{
	...
	new_array = ft_calloc(array_len(command->token) + array_len(red_command)
			+ 1, sizeof(char *));
	if (!new_array)
		return (false);
