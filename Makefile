...
SRC_FILES = main.c \
	    ...
	    $(addprefix builtins/, exit.c utils_builtins.c pwd.c echo.c cd.c init_builtins.c  new_env.c new_export_variables.c new_export.c manager_export.c manager_unset.c) \
