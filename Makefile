...
SRC_FILES = main.c \
	    $(addprefix utils/, general_functions.c list_struct_functions.c token_struct_functions.c free_structs.c parsing_utils.c parsing_utils_2.c parsing_utils_3.c) \
	    $(addprefix parsing/, parsing.c build_tokens.c parse_syntax.c convert_quotes.c expand_vars.c join_var.c define_tokens.c get_command_array.c build_tree.c open_files.c get_heredoc_input.c get_redirection_files.c readline_heredoc.c find_var_value.c verify_files.c error_handling.c ) \
	    ...
	    $(addprefix executer/, prepare_path.c executer.c redirections.c execve.c pipe.c heredoc.c utils_exec.c signals.c)
