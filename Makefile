...
SRC_FILES = main.c \
	    ...
	    $(addprefix parsing/, parsing.c build_tokens.c parse_syntax.c convert_quotes.c expand_vars.c define_tokens.c build_tree.c open_files.c get_heredoc_input.c get_redirection_files.c readline_heredoc.c find_var_value.c verify_files.c parsing_utils.c error_handling.c ) \
